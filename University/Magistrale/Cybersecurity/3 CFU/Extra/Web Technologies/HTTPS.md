...
1. **Sicurezza su TLS:** Sfrutta TLS (il successore di SSL) per fornire tre garanzie di sicurezza fondamentali che mancano a HTTP:
    ...
    - **Confidenzialità (Encryption):** Il traffico tra client e server è crittografato. Questo previene l'intercettazione (_sniffing_) dei dati, come password o cookie di sessione.

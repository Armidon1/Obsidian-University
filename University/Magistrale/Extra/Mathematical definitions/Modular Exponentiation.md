...
È una **funzione unidirezionale ([[OWF]])**: è computazionalmente facile da eseguire (grazie allo _Square-and-Multiply_), ma estremamente difficile da invertire (questo è il **[[The Discrete Logarithm (DL) Problem]]**).
